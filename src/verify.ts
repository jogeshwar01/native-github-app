export async function verifyWebhookSignature(payload: any, signature: any, secret: any) {
  if (!signature) {
...
function safeCompare(expected: any, actual: any) {
